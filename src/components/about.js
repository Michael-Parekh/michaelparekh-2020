  ...
  >
    ...
    <Container>
      <Row>
        <Col md={7}>
          <ul>
            <li>📚 Senior @ William Fremd High School</li>
            <li>📱 Building iOS apps with Swift/Objective-C</li>
            <li>🚵‍ Biking a total of 1000 miles in 2020</li>
    ...
    <p className="about-paragraph">
      ...
      around the world. <span className="highlight">CS is a superpower</span> that has allowed me to build my visionary ideas into a reality,
